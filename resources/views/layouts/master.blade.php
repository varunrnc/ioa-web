                        ...
                        <form class="d-flex header__search--form" action="#">
                            <div class="header__select--categories select">
                                <select class="header__select--inner">
                                    ...
                                    <option value="2">Decorative Balls</option>
                                    <option value="3">Pest Killer</option>
                                    <option value="4">Cocopeat </option>
                            ...
                            <ul class="d-flex">
                                ...
                                <li class="header__menu--items">
                                    ...
                                    <ul class="header__sub--menu">
                                        ...
                                        <li class="header__sub--menu__items"><a href="{{route('contact.page')}}" class="header__sub--menu__link">Contact Us</a></li>
                        ...
                        <div class="header__menu">
                            <nav class="header__menu--navigation">
                                <ul class="d-flex">
                                    ...
                                    <li class="header__menu--items mega__menu--items">
                                        <a class="header__menu--link text-white" >Shop 
                                            <svg class="menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12" height="7.41" viewBox="0 0 12 7.41">
                                                <path  d="M16.59,8.59,12,13.17,7.41,8.59,6,10l6,6,6-6Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7"/>
                                            </svg>
                                        </a>
                                        <ul class="header__mega--menu d-flex">
                                            <li class="header__mega--menu__li">
                                                <span class="header__mega--subtitle">Category One</span>
                                                <ul class="header__mega--sub__menu">
                                                    <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" >OGD01</a></li>
                                                    <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title">OGD02</a></li>
                                                    <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" >OGD03</a></li>
                                                    <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" >OGD04</a></li>
                                                    <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" >OGD05</a></li>
                                                </ul>
                                            </li>
                                            <li class="header__mega--menu__li">
                                                <span class="header__mega--subtitle">Category Two</span>
                                                <ul class="header__mega--sub__menu">
                                                    <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" >OGD01</a></li>
                                                    <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title">OGD02</a></li>
                                                    <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" >OGD03</a></li>
                                            ...
                                            <li class="header__mega--menu__li">
                                                <span class="header__mega--subtitle">Category Three</span>
                                                <ul class="header__mega--sub__menu">
                                                    <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" >OGD01</a></li>
                                                    <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title">OGD02</a></li>
                                                    <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" >OGD03</a></li>
                                            ...
                                            <li class="header__mega--menu__li">
                                                <span class="header__mega--subtitle">Category Four</span>
                                                <ul class="header__mega--sub__menu">
                                                    <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" >OGD01</a></li>
                                                    <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title">OGD02</a></li>
                                                    <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" >OGD03</a></li>
                                    ...
                                    <li class="header__menu--items">
                                        <a class="header__menu--link text-white" >Blog                                           
                                        </a>                                        
                                    </li>
                                    
                                    
                                    <li class="header__menu--items">
                                        <a class="header__menu--link text-white" href="{{route('about.page')}}">About Us </a>  
                                    </li>
                                    <li class="header__menu--items">
                                        <a class="header__menu--link text-white" href="{{route('contact.page')}}">Contact Us </a>  
                                    </li>
                                </ul>
                            </nav>
                        </div>
            ...
            <div class="minicart__product">
                <div class="minicart__product--items d-flex">
                    <div class="minicart__thumb">
                        <a href="product-details.html"><img src="assets/img/product/1.png" alt="prduct-img"></a>
                    </div>
                    <div class="minicart__text">
                        <h4 class="minicart__subtitle"><a href="product-details.html">OGD01</a></h4>
                ...
                <div class="minicart__product--items d-flex">
                    <div class="minicart__thumb">
                        <a href="product-details.html"><img src="assets/img/product/2.png" alt="prduct-img"></a>
                    </div>
                    <div class="minicart__text">
                        <h4 class="minicart__subtitle"><a href="product-details.html">OGD07</a></h4>
                ...
                <div class="row main__footer--wrapper footer__top--row">
                    <div class="col-lg-3 footer__col--width col-md-7 footer__col--padding footer__col--order">
                        <div class="footer__widget">
                            ...
                            <div class="footer__widget--inner">
                                <a class="footer__widget--logo" href="index.html"><img src="assets/img/logo/logo.png" alt="footer-logo" style="max-width: 29%;"></a>
                    ...
                    <div class="col-lg-2 footer__col--width col-md-4 footer__col--padding">
                        <div class="footer__widget">
                            ...
                            <ul class="footer__widget--menu footer__widget--inner">
                                <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" >All Products</a></li>
                                <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" >Grocery & Frozen</a></li>
                                <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" >Fresh Fruits</a></li>
                                <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" >Package Foods</a></li>
                                <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" >Organic Foods</a></li>
                                <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" >Health & Wellness</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-2 footer__col--width col-md-4 footer__col--padding">
            ...
            <div class="footer__bottom">
                <div class="row justify-content-between align-items-center">
                    <div class="col-12 col-md-auto">
                        <p class="copyright__content">Copyright © 2022 <a class="copyright__content--link text__primary" href="index.html">IOA</a> . All Rights Reserved.</p>
                    </div>
                    <div class="col-12 col-md-auto">
...
<!-- Mirrored from risingtheme.com/html/demo-grocee/grocee/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 May 2022 12:11:48 GMT -->
</html>