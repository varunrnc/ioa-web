		...
		<div class="col-md-12">
			<div class="row">
				...
				<div class="col-sm-2">
					...
					<input type="text" class="form-control" name="ogd_no" placeholder="Hint - OGD1..2..3..">
				</div>
				<div class="col-sm-2">
				...
				<div class="col-sm-4">
					<label for="" class="form-label">Shipping Charge ( default
						<input type="checkbox" name="shipping_checkbox" value="{{Hpx::shipping_charge()}}" checked> )
					</label>
					<input type="text" class="form-control" name="shipping_charge" value="{{Hpx::shipping_charge()}}" readonly>
				</div>			
				<div class="col-sm-3">
	...
	$(document).ready(function(){
		...
		$('input[name="shipping_checkbox"]').click(function(){
			if($(this).prop('checked') == true){
				...
				$('input[name="shipping_charge"]').val('0.00').prop('readonly',false);
			}
		});
