...
@section('main-content')
    ...
    <div class="admin-container">
        ...
        @php
            $tbx['tb'] = 1;
            $tbx['title'] = 'Add Shipping Charge';
            $route_name = 'category';
            $dummy_image = asset('assets/img/other/select-image.jpg');
        @endphp
        @include('admin.includes.title-bar')

        <form id="frm" class="row" action="{{ route('admin.shipping.save') }}" method="POST">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <select class="form-select" name="product">
                        ...
                        <option value="Fartilizer">Fertilizer</option>
                ...
                <div class="col-12">
                    ...
                    <input type="number" class="form-control" name="shipping_charges">
