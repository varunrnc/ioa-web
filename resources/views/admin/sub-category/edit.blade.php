...
@section('main-content')
    ...
    <div class="admin-container">
        ...
        <form id="frm" class="row" action="{{ route('admin.sub-category.update') }}" method="POST"
            ...
            <div class="col-sm-4 position-relative">
                ...
                <img src="{{ url($data->img->image) }}" id="showBanner" class="show-banner img-hover"
