...
@section('main-content')
    ...
    <div class="admin-container">
        ...
        @php
            $tbx['tb'] = 1;
            $tbx['title'] = 'Plant Sub-Category';
            $tbx['btn-name'] = 'Add';
            $tbx['btn-link'] = route('admin.mplant.subcategory.create');
            $tbx['search-bar'] = true;
                ...
                <tbody class="cart__table--body" id="slider-list">
                    @foreach ($data as $item)
                        <tr class="cart__table--body__items">
                            ...
                            <td class="cart__table--body__list">
                                <h3 class="cart__content--title"><a href="#">{{ $item->category }}</a></h3>
                            </td>
                            ...
                            <td class="cart__table--body__list text-right">
                                <a class="btn btn-sm fs-4 btn-outline-secondary edit__btn"
                                    href="{{ route('admin.mplant.subcategory.edit', $item->id) }}">Edit</a>
                                <a id="{{ $item->id }}" href="#"
...
@section('script')
    <script>
        ...
        function status(id) {
            ...
            let req = api.setData("{{ route('admin.mplant.subcategory.status') }}", data);
            req.then((res) => {
                if (res.status == true) {
        ...
        function deleteItem(id) {
            ...
            let req = api.setData("{{ route('admin.mplant.subcategory.delete') }}", data);
