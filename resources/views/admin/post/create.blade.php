		...
		<div class="col-md-12">
			<div class="row">
				...
				<div class="col-12">
					...
					<textarea class="form-control" id="html_content" name="content" hidden></textarea>
				</div>
				...
				<div class="col-md-6">
					<label class="form-label">Featured Image (650x350)</label>
					<img src="{{asset('assets/img/other/select-image.jpg')}}" id="showBanner" class="show-banner img-hover mt-1" data-dummy-image="{{$dummy_image}}">
				...
				<!-- <div class="col-md-4">
					...
					<img src="{{asset('assets/img/other/select-image.jpg')}}" id="showBanner2" class="show-banner img-hover mt-1" data-dummy-image="{{$dummy_image}}">
