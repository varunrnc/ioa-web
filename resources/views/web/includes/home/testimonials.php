...
<section class="testimonial__section testimonial__bg mt-5 py-5">
        ...
        <div class="testimonial__section--inner testimonial__swiper--activation swiper">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="testimonial__items d-flex align-items-center">
                        <div class="testimonial__items--thumbnail">
                            <img class="testimonial__items--thumbnail__img" src="assets/img/testimonials/m1.png" alt="testimonial-img">
                        </div>
                        <div class="testimonial__items--content">
                            <h3 class="testimonial__items--title">Subhash Chandra Pandey</h3>
                            <span class="testimonial__items--subtitle">Jharkhand</span>
                            <p class="testimonial__items--desc">I Purchased The Flower Fertilizer Ogd1 , It Really Worked Well.</p>
                ...
                <div class="swiper-slide">
                    <div class="testimonial__items d-flex align-items-center">
                        <div class="testimonial__items--thumbnail">
                            <img class="testimonial__items--thumbnail__img" src="assets/img/testimonials/f1.png" alt="testimonial-img">
                        </div>
                        <div class="testimonial__items--content">
                            <h3 class="testimonial__items--title">Twinkle Bhayana</h3>
                            <span class="testimonial__items--subtitle">Haryana</span>
                            <p class="testimonial__items--desc">OGD22 Worked Really Well For My Mealybug Attack, Good Product</p>
                            <div class="ratting testimonial__ratting">
                                <ul class="d-flex testimonial__ratting--inner">
                                    <li class="testimonial__ratting--list">
                                        <span class="testimonial__ratting--icon">
                ...
                <div class="swiper-slide">
                    <div class="testimonial__items d-flex align-items-center">
                        <div class="testimonial__items--thumbnail">
                            <img class="testimonial__items--thumbnail__img" src="assets/img/testimonials/m2.png" alt="testimonial-img">
                        </div>
                        <div class="testimonial__items--content">
                            <h3 class="testimonial__items--title">Phurailatpam Krishnagopal Sharma</h3>
                            <span class="testimonial__items--subtitle">Manipur</span>
                            <p class="testimonial__items--desc">Their OGD21 All Purpose Pesticides Is Really Affective On Insects Like Aphids!</p>
                            <div class="ratting testimonial__ratting">
                                <ul class="d-flex testimonial__ratting--inner">
                                    <li class="testimonial__ratting--list">
                                        <span class="testimonial__ratting--icon">
                ...
                <div class="swiper-slide">
                    <div class="testimonial__items d-flex align-items-center">
                        <div class="testimonial__items--thumbnail">
                            <img class="testimonial__items--thumbnail__img" src="assets/img/testimonials/f2.png" alt="testimonial-img">
                        </div>
                        <div class="testimonial__items--content">
                            <h3 class="testimonial__items--title">Vaishaly Rajput</h3>
                            <span class="testimonial__items--subtitle">Pune Maharashtra</span>
                            <p class="testimonial__items--desc">The Vermicompost Is Just Wonderful.</p>
                            <div class="ratting testimonial__ratting">
                                <ul class="d-flex testimonial__ratting--inner">
                                    <li class="testimonial__ratting--list">
                                        <span class="testimonial__ratting--icon">
                ...
                <div class="swiper-slide">
                    <div class="testimonial__items d-flex align-items-center">
                        <div class="testimonial__items--thumbnail">
                            <img class="testimonial__items--thumbnail__img" src="assets/img/testimonials/f3.png" alt="testimonial-img">
                        </div>
                        <div class="testimonial__items--content">
                            <h3 class="testimonial__items--title">Indrani Manjunath</h3>
                            <span class="testimonial__items--subtitle">Karnataka</span>
                            <p class="testimonial__items--desc">Bought Two Products OGD4 & OGD6 It Really Enhance The Fertility.</p>
                            <div class="ratting testimonial__ratting">
                                <ul class="d-flex testimonial__ratting--inner">
                                    <li class="testimonial__ratting--list">
                                        <span class="testimonial__ratting--icon">
