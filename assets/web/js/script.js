...
const headerStickyWrapper = document.querySelector("header"),
    headerStickyTarget = document.querySelector(".header__sticky--disable");
    ...
    document.querySelectorAll(accordionWrapper).forEach((function(item) {
        item.addEventListener("click", (function(evt) {
            ...
            if (itemTarget.classList.contains("accordion__items--button") || itemTarget.classList.contains("widget__categories--menu__label")) {
                if(itemTarget.closest(singleItem) != null){
...
}), customAccordion(".accordion__container", ".accordion__items", ".accordion__items--body"), customAccordion(".widget__categories--menu", ".drop_menu", ".widget__categories--sub__menu");
let accordion = !0;
